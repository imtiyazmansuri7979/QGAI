...
setlocal
chcp 65001 >nul
title QGAI - FS67-02 - Tier1 Active
...
echo ============================================================
echo   %RUN_ID% - 67 FEATURE SWEEP - TIER 1 ACTIVE
echo ------------------------------------------------------------
echo   Result folder:
...
echo   - Tests active features by removing one at a time.
echo   - If one feature fails, the sweep aborts; rerun after fixing the error.
echo ============================================================
