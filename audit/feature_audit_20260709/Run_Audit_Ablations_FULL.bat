...
title QGAI Feature Audit Ablations FULL

set ROOT=%~dp0workspace
set PY=C:\Users\user\AppData\Local\Programs\Python\Python312\python.exe
set START=2025-06-23
set END=2026-06-29

echo ============================================================
echo   QGAI FEATURE AUDIT ABLATIONS - FULL WFO
echo ------------------------------------------------------------
echo   This can take many hours.
echo   Resume-safe: run_wfo.py skips cached completed weeks.
echo.
...
echo %ROOT%\backtest\results\audit_full_*
pause
exit /b 0
...
echo ------------------------------------------------------------
set QGAI_ABLATE=%ABL%
"%PY%" run_wfo.py --start %START% --end %END% --buf 0.15 --tp-equity 0 --equity 10000 --risk 3 --tp-regime --results-dir audit_full_%NAME%
exit /b 0
